...
TARGET = motor_position_PID
#TARGET = encoderReader_Sahil
...
SERIAL_AVRDUDE = "C:\Program Files (x86)\arduino-0017\hardware\tools\avr\bin\avrdude"
SERIAL_AVRDUDE_CONFIG = "C:\Program Files (x86)\arduino-0017\hardware\tools\avr\etc\avrdude.conf"
